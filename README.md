...
<p>
  ...
  &nbsp;
  <a href="mailto:usamasheikh.dev@gmail.com">
...
> _"I don't just write code — I engineer systems that scale."_

I'm a **Full Stack Engineer with 2+ years of experience** building and maintaining production-grade **SaaS platforms**, **AI-powered automation workflows**, and **scalable backend infrastructure**.

| 🔭 Currently   | Building **NextServe** — a multi-restaurant SaaS platform at **Rayon Studios** |
| -------------- | ------------------------------------------------------------------------------ |
| 🤖 AI Focus    | Agent-based automation systems using **Genkit / Google Agent SDK**             |
| 🧠 Expertise   | REST APIs · Database Architecture · Cloud Deployments (GCP)                    |
| 🌱 Leveling Up | Testing frameworks · Containerization · Enterprise backend patterns            |
| ⚡ My Edge     | End-to-end feature ownership — from requirements to production                 |
...
**🏢 Full Stack Engineer**
[Rayon Studios](#) · _Oct 2024 – Present_
...
- ⚙️ Design & implement **scalable REST APIs** using Node.js, Express.js, PostgreSQL & Prisma for web, mobile, and AI-powered applications
- 🎯 Own **end-to-end feature delivery** — from requirement analysis and DB design to frontend implementation and production deployment
- 🤖 Build & integrate **AI-powered agents** and automation workflows for business operations and customer interactions
- ☁️ Support production deployments and infrastructure operations on **Google Cloud Platform (GCP)**
...
### NextServe — Restaurant Management SaaS

_Private company product — code not publicly available_

A **multi-restaurant management platform** supporting operational workflows, customer management, and order processing.

**Key Contributions:**

- 🗄️ Designed and optimized PostgreSQL database structures for scalability and maintainability
- 🔗 Built RESTful APIs connecting web, mobile, and backend services
- 🤖 Developed an **AI-powered Smart Ordering Agent** to automate customer ordering workflows

</td>
</tr>
</table>

> 💡 **Looking for my public code?** Check out my personal repos below — feel free to explore!

---

## 🎓 Education

🎓 **B.E. Electrical Engineering** — NED University of Engineering & Technology, Karachi, Pakistan
...
_Always open to discussing full-stack architecture, AI-driven automation, and interesting engineering problems._

[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/muhammadusamasheikh)
&nbsp;
[![Email](https://img.shields.io/badge/Send_an_Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:usamasheikh.dev@gmail.com)

<br/>

_⭐ If you find my work interesting, consider giving my repos a star!_
